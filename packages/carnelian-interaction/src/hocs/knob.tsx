...
import { HandleControl, HitArea, DraggingActionPayload, useControls } from "..";
import { Point } from "../geometry";

export interface KnobController<T extends object, D = any> {
    hitArea: HitArea<D> | ((props: T) => HitArea<D>);
    getPosition(props: T): Point;
    setPosition<D>(props: DiagramElementProps<T>, payload: DraggingActionPayload, hitArea: HitArea<D>): DiagramElementProps<T>;
}
...
export function useKnob<T extends object>(knobController: KnobController<T>, props: DiagramElementProps<T>) {
    ...
    function dragHandler(payload: DraggingActionPayload) {
